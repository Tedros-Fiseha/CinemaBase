        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            foreach (['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'] as $day) {
                ...
                $operatingHours[$day] = [
                    ...
                    'end_time' => formatTime($_POST[$endKey] ?? null, '12:00 AM'),     // Default end time
                ];
            }
            ...
            $data = [
                ...
                'languages' => htmlspecialchars(implode(',', $_POST['language'] ?? [])),
...
// okay i want to check a scenario where the tin number has some conditions to meet and if it is satisfiied i want the registered cinema to get their username and password via email now is there also a free tool that allows me to send email from the server if the condition is met, and if not it will prompt to register again by inputing a legit tin number 